...
import CreatePrivateLessonContent from "../../components/privateLessons/CreatePrivateLessonContent";

export default function CreatePrivateLessonPage() {
