...
import InquiryTeacherDetailsContent from "@/app/components/inquiryTeacher/InquiryTeacherDetailsContent";
import { useAppSelector } from "../../store/hooks";
import type { RootState } from "../../store/store";

export default function InquiryTeacherDetailsPageClient() {
