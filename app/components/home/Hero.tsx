...
export default function Hero() {
  ...
  return (
    <section className="relative flex flex-col md:flex-row   md:min-h-[700px] items-center justify-between py-10 md:py-20 overflow-x-hidden px-4 md:px-10 lg:px-28">

      {/* Left side - Text content */}
      <div className="relative z-10 flex flex-col gap-4 md:gap-6 max-w-2xl w-full md:w-auto mt-10 md:mt-0">
        <p className={`text-lg md:text-2xl font-medium animate-fade-in-left animate-delay-100 ${theme === "dark" ? "text-white" : "text-blue-950"}`}>{t("hero.welcome")}</p>
        ...
        <p className={`text-base md:text-lg lg:text-xl font-light animate-fade-in-left animate-delay-400 ${theme === "dark" ? "text-white/90" : "text-gray-700"}`}>
          {t("hero.tagline")}
        </p>
      </div>

      {/* Right side - Three student images with yellow ring */}
      <div className="relative z-10 hidden md:flex items-center overflow-visible">
        {/* Yellow ring in the background */}
        <div className="absolute -right-16 -top-12 w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px] pointer-events-none z-0 animate-scale-in animate-delay-300">
        ...
        <div className="relative flex items-end gap-2 md:gap-3 lg:gap-4 z-10">
          {/* Student 1 - Left (Male with books, green plaid shirt) */}
          <div className="relative w-20 h-40 md:w-24 md:h-48 lg:w-30 lg:h-64 rounded-xl md:rounded-2xl overflow-hidden shadow-2xl bg-blue-500 animate-fade-in-right animate-delay-400 hover:scale-105 transition-transform duration-300">     
              <Image
          ...
          <div className="relative w-24 h-48 md:w-28 md:h-60 lg:w-36 lg:h-80 rounded-xl md:rounded-2xl overflow-hidden shadow-2xl bg-yellow-400 animate-fade-in-right animate-delay-500 hover:scale-105 transition-transform duration-300">            
              <Image
          ...
          <div className="relative w-24 h-44 md:w-28 md:h-56 lg:w-36 lg:h-68 rounded-xl md:rounded-2xl overflow-hidden shadow-2xl bg-teal-400 animate-fade-in-right animate-delay-600 hover:scale-105 transition-transform duration-300">           
              <Image
